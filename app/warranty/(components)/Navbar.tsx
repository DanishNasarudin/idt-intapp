...
const Navbar = (props: Props) => {
  ...
  return (
    <div
      className=" z-[2]
      fixed
    flex flex-col justify-between px-4 py-4 max-w-[220px] w-full h-[100vh]
        ...
        <div className="flex flex-col gap-2">
          ...
          <Link href={"/warranty/jb"}>
            ...
            >
              ...
              <p className="font-medium">Johor Bahru</p>
            </button>
          </Link>
        </div>
      </div>
      <div className="flex items-center gap-4 py-2 px-2 rounded-md border-[1px] border-zinc-800">
